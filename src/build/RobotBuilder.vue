<template>
<div v-if="availableParts" class="content"><!--in case asynchronous call return null at first-->
    <div class="preview">
      <CollapsibleSection>
...
export default {
     ...
     beforeRouteLeave(to, from, next){
           if(this.addedToCart){
             ...
             const msg = 'You have not added your robot to your cart, are you sure you want to leave?';
