...
export default {
     ...
     computed:{// complex calculation logic we put it here,do not put too much logic in template
         saleBorderClass(){
     ...
     methods:{
       ...
       selectPreviousHead(){
         this.selectedHeadIndex = getPreviousValiIndex
              (this.selectedHeadIndex,availableParts.heads.length);
       },
        selectNextLeftArm(){
       ...
       selectPreviousLeftArm(){
         this.selectedLeftArmIndex = getPreviousValiIndex
              (this.selectedLeftArmIndex,availableParts.arms.length);
       },
        selectNextRightArm(){
       ...
       selectPreviousRightArm(){
         this.selectedRightArmIndex = getPreviousValiIndex
              (this.selectedRightArmIndex,availableParts.arms.length);
       },
       selectNextTorso(){
       ...
       selectPreviousTorso(){
         this.selectedTorsoIndex = getPreviousValiIndex
              (this.selectedTorsoIndex,availableParts.torsos.length);
       },
       selectNextBase(){
       ...
       selectPreviousBase(){
         this.selectedBaseIndex = getPreviousValiIndex
              (this.selectedBaseIndex,availableParts.bases.length);
       },
     }
 }
